...
wandb.init(project="MySfMLearner5", entity="respinosa")
...
class Trainer_Monodepth:
    ...
    def get_ilumination_invariant_loss(self, pred, target):
        ...
        wandb.log({"1": wandb.Image(features_p[0][0].data)},step=self.step)
        wandb.log({"2": wandb.Image(features_p[0][1].data)},step=self.step)
        wandb.log({"3": wandb.Image(features_p[0][2].data)},step=self.step)
        wandb.log({"4": wandb.Image(features_p[0][3].data)},step=self.step)
        wandb.log({"5": wandb.Image(features_p[0][4].data)},step=self.step)
        wandb.log({"6": wandb.Image(features_p[0][5].data)},step=self.step)
        wandb.log({"7": wandb.Image(features_p[0][6].data)},step=self.step)
        wandb.log({"8": wandb.Image(features_p[0][7].data)},step=self.step)
