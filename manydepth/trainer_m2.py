    ...
    def compute_losses(self, inputs, outputs):
        ...
        for scale in self.opt.scales:
            ...
            for frame_id in self.opt.frame_ids[1:]:
                ...
                target = inputs[("color", 0, 0)]
                loss_ilumination_invariant += (self.get_ilumination_invariant_loss(pred.detach(),target.detach()) * reprojection_loss_mask_iil).sum() / reprojection_loss_mask_iil.sum()
