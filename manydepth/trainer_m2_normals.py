...
class Trainer_Monodepth2:
    ...
    def compute_orth_loss4(self, disp, N_hat, K_inv):
        ...
        normal_flat = normal.view(1,-1, 2).expand(batch_size, -1, -1)
        rigth_flat = right.view(1,-1, 2).expand(batch_size, -1, -1)
        right_right_flat = right_right.view(1,-1, 2).expand(batch_size, -1, -1)
        bottom_flat = bottom.view(1,-1, 2).expand(batch_size, -1, -1)
        bottom_bottom_flat = bottom_bottom.view(1,-1, 2).expand(batch_size, -1, -1)
