...
wandb.init(project="MySfMLearnerNormals", entity="respinosa")
...
class Trainer_Monodepth2:
    ...
    def compute_losses(self, inputs, outputs):
        ...
        total_loss += 0.5 * self.compute_orth_loss(outputs[("disp", 0)], outputs["normal_inputs"][("normal", 0)], inputs[("inv_K", 0)],inputs[("color", 0, 0)])
